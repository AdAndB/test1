...
public class TeacherTestsPerDay {
    Vector<String> timeFrames;
    Vector<String> subjects;

    public TeacherTestsPerDay() {
    ...
    public int setDay(Connection connection, int dayId, int teacherId, int classId, Date date1, Date date2) throws SQLException {
